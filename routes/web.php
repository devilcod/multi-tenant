...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Tables
    Route::delete('tables/destroy', 'TableController@massDestroy')->name('tables.massDestroy');
    Route::resource('tables', 'TableController');

    // Kitchens
    Route::delete('kitchens/destroy', 'KitchenController@massDestroy')->name('kitchens.massDestroy');
